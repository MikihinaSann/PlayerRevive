...
public class PlayerReviveConfig {
    ...
    public static class Bleeding {
        ...
        @CreativeConfig
        public List<MobEffectConfig> bleedingEffects = Arrays.asList(new MobEffectConfig(Registries.STATUS_EFFECT, Identifier.of("minecraft",
            "slowness"), 2, 10, true));
    ...
    public static class Revive {
        ...
        @CreativeConfig
        public List<MobEffectConfig> revivedEffects = Arrays.asList(new MobEffectConfig(Registries.STATUS_EFFECT, Identifier.of("minecraft",
            "slowness"), 2, 1, true));
    ...
    public static class SelfRevive {
        ...
        @CreativeConfig
        public SoundConfig sound = new SoundConfig(Identifier.of("minecraft", "item.bundle.remove_one"));
    ...
    public static class Sounds {
        ...
        @CreativeConfig
        public SoundConfig death = new SoundConfig(Identifier.of(PlayerReviveFabric.MODID, "death"));
        @CreativeConfig
        public SoundConfig revived = new SoundConfig(Identifier.of(PlayerReviveFabric.MODID, "revived"));
